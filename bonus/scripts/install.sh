...
echo "Próximos pasos:"
echo ""
echo "1. Puedes acceder a GitLab en: http://gitlab.192.168.56.111.nip.io"
echo "    - usuario: root"
echo "    - contraseña: $DECODED"
echo ""
echo "2. Puedes acceder a Argo CD en: http://localhost:8081"
echo "    - usuario: admin"
echo "    - contraseña: $(kubectl -n argocd get secret argocd-initial-admin-secret -o jsonpath='{.data.password}' | base64 -d)"
echo ""
echo "3. Para desplegar la aplicación de ejemplo y subirla a GitLab, ejecuta:"
echo "     ./scripts/create-gitlab-project.sh"
echo ""
